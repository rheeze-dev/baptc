        ...
        "columns": [
            ...
            //{ "data": "shortName" },
            {
                "data": function () {
                    ...
                    var btnRange = "<select id='RoleRange'><option value='1000'>All</option><option value='5'>Top 5</option><option value='10'>Top 10</option><option value='20'>Top 20</option></select>";
                    return btnRange;
                }
            },
            {
